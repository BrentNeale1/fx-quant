"""
Download 2025 M15 data from Dukascopy for S19 target pairs.

Missing data (H1 already exists for all pairs):
  - EUR_USD M15
  - GBP_JPY M15
  - GBP_AUD M15
  (GBP_USD M15 already exists)
...
import pandas as pd
from dukascopy_python import fetch, INTERVAL_MIN_15, OFFER_SIDE_BID

PAIRS_TFS = [
    ("EUR/USD", "M15", INTERVAL_MIN_15),
    ("GBP/JPY", "M15", INTERVAL_MIN_15),
    ("GBP/AUD", "M15", INTERVAL_MIN_15),
]
...
def main():
    ...
    print(f"Downloading 2025 M15 data for S19 target pairs")
    ...
    if failed:
        ...
        print(f"\nNext: python src/run_s19_backtest.py")
